      ...
      <div className="space-y-10">
        <div className="space-y-2">
          ...
          <p className="max-w-md pt-7 text-lg text-gray-400">
            Designing and building infrastucture and user experiences alike. 
            I've been traveling and upskilling for the past year and I'm now looking for new opportunities.
          </p>
        </div>
